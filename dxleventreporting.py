...
#
# This program is based on the Cuckoo Sandbox Reporting Module example at
# https://github.com/cuckoosandbox/cuckoo/blob/2.0.5.3/docs/book/customization/reporting.rst,
# which is licensed under GNU General Public License version 3.
#
